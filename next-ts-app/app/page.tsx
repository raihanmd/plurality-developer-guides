...
const Home = () => {
  ...
  const getAllAccounts = async () => {
    ...
    if (response) {
      ...
      alert(`All Accounts: ${JSON.stringify(allAccounts[0])}`);
  ...
  const getMessageSignature = async (message: string) => {
    const response = (await PluralitySocialConnect.getMessageSignature(
      message
    )) as SignMessageDataType;
    if (response) {
  ...
  const getVerifyMessageData = async (message: string, key: string) => {
    const response = (await PluralitySocialConnect.verifyMessageSignature(
      message,
      key
    )) as VerifySignedMessageDataType;
    if (response) {
  ...
  const loadPublicData = async () => {
    const response = (await PluralitySocialConnect.getPublicData(
      "name"
    )) as ConnectedAccountDataType;
    if (response) {
      // const connectedAccount = response.data;
  ...
  const storePublicData = async () => {
    const response = (await PluralitySocialConnect.setPublicData(
      "name",
      "plural-abc"
    )) as ConnectedAccountDataType;
    if (response) {
  ...
  const loadPrivateData = async () => {
    const response = (await PluralitySocialConnect.getPrivateData(
      "work"
    )) as ConnectedAccountDataType;
    if (response) {
      // const connectedAccount = response.data;
  ...
  const storePrivateData = async () => {
    const response = (await PluralitySocialConnect.setPrivateData(
      "work",
      "Plurality"
    )) as ConnectedAccountDataType;
    if (response) {
  ...
  const updateConsent = async () => {
    const response =
      (await PluralitySocialConnect.updateConsentOption()) as ConnectedAccountDataType;
    if (response) {
  ...
  const fetchLoginInfo = async () => {
    const response =
      (await PluralitySocialConnect.getLoginInfo()) as ConnectedAccountDataType;
    if (response) {
  ...
  const fetchBlockNumber = async (rpc: string, chainId: string) => {
    const response = (await PluralitySocialConnect.getBlockNumber(
      rpc,
      chainId
    )) as GetBlockNumberDataType;
    if (response) {
  ...
  const fetchTransactionCount = async (
    ...
    const response = (await PluralitySocialConnect.getTransactionCount(
      ...
      rpc,
      chainId
    )) as GetTransactionCountDataType;
    if (response) {
      ...
      >
        {isLogin && (
          <div>
            ...
            &nbsp;
            <button onClick={() => getConnectedAccount()}>
              Get Connected Account
            </button>
            &nbsp;
            <button
              onClick={() =>
                getMessageSignature("Example `personal_sign` message.")
              }
            >
              Sign Message
            </button>
            ...
            <br />
            <button onClick={() => storePublicData()}>
              Set Public Metadata
            </button>
            &nbsp;
            <button onClick={() => loadPublicData()}>
              Get Public Metadata
            </button>
            &nbsp;
            <button onClick={() => storePrivateData()}>
              Set Private Metadata
            </button>
            &nbsp;
            <button onClick={() => loadPrivateData()}>
            ...
            &nbsp;
            <button onClick={() => fetchSmartProfileData()}>
